...
public class GenericDAOJPA<T, ID extends Serializable> implements GenericDAO<T, ID> {
	...
	@PersistenceContext(unitName = "polla-unit")
	...
	public GenericDAOJPA() {
		...
		this.persistentClass = (Class<T>) ((ParameterizedType) clazz.getGenericSuperclass())
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.firebyte.dao.ç#findByNamedQuery(java.lang.String,
	 * java.lang.Object[])
	 *
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @see
	 * org.firebyte.dao.GenericDAO#findByNamedQueryAndNamedParams(java.lang.String,
	 * java.util.Map)
	 */
	@SuppressWarnings("unchecked")
	@Override
